...
import { User, Lock, Info, Calendar, DollarSign, Users, Briefcase, Tags, MapPin, Building2 } from 'lucide-react';
...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      setisloading(true);
      const res = await axios.post("https://internshala-clone-t1w6.onrender.com/api/internship", formData);
