...
const applications = [
    {
        ...
        company: "Tech Corp",
        category: "Software",
        user: { name: "Bhanu", email: "john@example.com" },
        createdAt: "2024-03-10T12:00:00Z", // ✅ fixed key
        status: "approved",
    },
    {
        _id: "2",
        ...
        category: "Healthcare",
        user: { name: "Bhanu", email: "jane@example.com" },
        createdAt: "2024-03-08T10:30:00Z", // ✅ fixed key
        status: "pending",
    },
    {
        _id: "3",
        company: "EduLearn",
        category: "Education",
        user: { name: "Bhanu", email: "alice@example.com" },
        createdAt: "2024-03-05T09:15:00Z", // ✅ fixed key
        status: "rejected",
    },
];
...
//    });
  ...
  const filteredApplications = userApplications.filter((application:any) => {
    const searchMatch =
